# 🎙️ Text-to-Podcast Automation (Text2Podcast)
...
## 🎧 Try the Experience (Samples)

If you want to see the output quality before running the full pipeline, check out the `/sample` folder:

* **`sample/9mvx9v.md`**: This is the "Cleaned Script" generated by AI. 
* **`sample/9mvx9v.mp3`**: The final result. This demonstrates the Azure Neural Voice synthesis.
